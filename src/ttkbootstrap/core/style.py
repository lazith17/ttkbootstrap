...
class Style(ttk.Style):
    ...
    def __init__(self, themename='flatly', themes_file=None, master=None):
        ...
        self.styler = None
        self.theme_definitions = ThemeDefinition.load_themes(
    ...
    def theme_use(self, themename=None):
        ...
        if all([themename, themename not in self.themes]):
            print(
                f"{themename} is not a valid theme name. Please try one of the following:")
...
class StylerTK:
    ...
    def _style_canvas(self):
        ...
        self._set_option('*Canvas.highlightBackground',
    ...
    def _style_checkbutton(self):
        ...
        self._set_option('*Checkbutton.activeForeground',
    ...
    def _style_radiobutton(self):
        ...
        self._set_option('*Radiobutton.activeForeground',
                         self.theme.colors.primary)
    ...
    def _style_scale(self):
        ...
        self._set_option('*Scale.highlightBackground',
                         self.theme.colors.border)
    ...
    def _style_spinbox(self):
        ...
        self._set_option('*Spinbox.highlightBackground',
                         self.theme.colors.border)
    ...
    def _style_listbox(self):
        ...
        self._set_option('*Listbox.selectBackground',
                         self.theme.colors.selectbg)
        self._set_option('*Listbox.selectForeground',
                         self.theme.colors.selectfg)
        ...
        self._set_option('*Listbox.highlightBackground',
                         self.theme.colors.border)

    def _style_menubutton(self):
        """Apply style to ``tkinter.Menubutton``"""
        hover_color = ThemeColors.update_hsv(
            self.theme.colors.primary, vd=-0.2)
    ...
    def _style_labelframe(self):
        ...
        self._set_option('*Labelframe.highlightColor',
                         self.theme.colors.border)
    ...
    **ttkbootstrap** themes is *clam*. In many cases, widget layouts are re-created using an assortment of elements from
    ...
    def update_ttk_theme_settings(self):
        ...
        for color in self.theme.colors:
            self.settings.update(self.style_solid_buttons(theme=self.theme,
                                                          background=color, style=f'{color}.TButton'))

        # default style
        self.settings.update(self.style_solid_buttons(
            theme=self.theme, style='TButton'))
    ...
    def _style_combobox(self):
        ...
        *clam* and *default* theme elements.
        ...
        """
        disabled_fg = (ThemeColors.update_hsv(self.theme.colors.inputbg, vd=-0.2) if self.theme.type == 'light' else
                       ThemeColors.update_hsv(self.theme.colors.inputbg, vd=-0.3))
    ...
    def _create_striped_progressbar_image(self, colorname):
        ...
        brightness = colorsys.rgb_to_hsv(
            *ThemeColors.hex_to_rgb(bar_primary))[2]
        if brightness < 0.4:
            value_delta = 0.3
        elif brightness > 0.8:
            value_delta = 0
            ...
            value_delta = 0.1
        bar_secondary = ThemeColors.update_hsv(
            bar_primary, sd=-0.2, vd=value_delta)
        ...
        draw = ImageDraw.Draw(h_im)
        draw.polygon([(0, 0), (48, 0), (100, 52), (100, 100),
                     (100, 100)], fill=bar_primary)
    ...
    def _style_scale(self):
        ...
        trough_color = (self.theme.colors.inputbg if self.theme.type == 'dark' else
                        ThemeColors.update_hsv(self.theme.colors.inputbg, vd=-0.03))
    ...
    def _create_scrollbar_images(self):
        ...
        font_size = 13
        with importlib.resources.open_binary('ttkbootstrap.core', 'Symbola.ttf') as font_path:
        ...
        up_draw.text((1, 5), "🞁", font=fnt,
                     ...
                     ThemeColors.update_hsv(self.theme.colors.selectbg, vd=0.35, sd=-0.1))
        ...
        self.settings.update({
            ...
            'TScrollbar': {
                'configure': {
                    ...
                    'background':
                        ThemeColors.update_hsv(self.theme.colors.bg, vd=-0.15) if self.theme.type == 'light' else
                        ThemeColors.update_hsv(
                            self.theme.colors.selectbg, vd=0.25, sd=-0.1),
                    'width': 16},
                'map': {
                    'background': [
                        ('pressed',
                         ThemeColors.update_hsv(self.theme.colors.bg, vd=-0.35) if self.theme.type == 'light' else
                         ThemeColors.update_hsv(self.theme.colors.selectbg, vd=0.05)),
                        ('active',
                         ThemeColors.update_hsv(self.theme.colors.bg, vd=-0.25) if self.theme.type == 'light' else
                         ThemeColors.update_hsv(self.theme.colors.selectbg, vd=0.15))]}}})
    ...
    def _style_spinbox(self):
        ...
        if self.theme.type == 'dark':
            self.settings.update(
                {'custom.Spinbox.field': {'element create': ('from', 'default')}})
    ...
    def style_solid_buttons(theme, anchor='center', background=None, font=None, foreground=None, style=None):
        ...
        disabled_bg = (ThemeColors.update_hsv(theme.colors.inputbg, vd=-0.2) if theme.type == 'light' else
                       ThemeColors.update_hsv(theme.colors.inputbg, vd=-0.3))
            ...
            f'{style}': {
                ...
                'map': {
                    ...
                    'background': [
                        ...
                        ('pressed !disabled', ThemeColors.update_hsv(
                            background, vd=pressed_vd)),
        ...
        self.settings.update({
            'Outline.TButton': {
                ...
                'map': {
                    ...
                    'background': [
                        ('pressed !disabled', ThemeColors.update_hsv(
                            self.theme.colors.primary, vd=pressed_vd)),
                        ('hover !disabled', self.theme.colors.primary)],
                    'bordercolor': [
                        ('disabled', disabled_fg),
                        ('pressed !disabled', ThemeColors.update_hsv(
            ...
            self.settings.update({
                f'{color}.Outline.TButton': {
                    ...
                    'map': {
                        ...
                        'background': [
                            ('pressed !disabled', ThemeColors.update_hsv(
                                self.theme.colors.get(color), vd=pressed_vd)),
                            ('hover !disabled', self.theme.colors.get(color))],
                        'bordercolor': [
                            ('disabled', disabled_fg),
                            ('pressed !disabled', ThemeColors.update_hsv(
            ...
            'Link.TButton': {
                ...
                'map': {
                    'foreground': [
                        ('disabled', disabled_fg),
                        ('pressed !disabled', ThemeColors.update_hsv(
                            self.theme.colors.info, vd=pressed_vd)),
    ...
    def _create_squaretoggle_image(self, colorname):
        ...
        draw.rectangle([1, 1, 225, 129], outline=off_border,
                       width=6, fill=off_fill)
        draw.rectangle([18, 18, 110, 110], fill=off_indicator)

        toggle_on = Image.new('RGBA', (226, 130))
        draw = ImageDraw.Draw(toggle_on)
        draw.rectangle([1, 1, 225, 129], outline=on_border,
                       width=6, fill=on_fill)
    ...
    def _create_roundtoggle_image(self, colorname):
        ...
        toggle_off = Image.new('RGBA', (226, 130))
        draw = ImageDraw.Draw(toggle_off)
        draw.rounded_rectangle([1, 1, 225, 129], radius=(
            128 / 2), outline=off_border, width=6, fill=off_fill)
        draw.ellipse([20, 18, 112, 110], fill=off_indicator)

        toggle_on = Image.new('RGBA', (226, 130))
        draw = ImageDraw.Draw(toggle_on)
        draw.rounded_rectangle([1, 1, 225, 129], radius=(
            128 / 2), outline=on_border, width=6, fill=on_fill)
        ...
        draw = ImageDraw.Draw(toggle_disabled)
        draw.rounded_rectangle([1, 1, 225, 129], radius=(
            128 / 2), outline=disabled_fg, width=6)
            ...
            self.settings.update({
                f'{color}.Roundtoggle.Toolbutton.indicator': {
                    'element create': ('image', self.theme_images[f'{color}_roundtoggle_on'],
                                       ('disabled',
                                        self.theme_images[f'{color}_roundtoggle_disabled']),
                                       ('!selected',
            ...
            self.settings.update({
                f'{color}.Squaretoggle.Toolbutton.indicator': {
                    'element create': ('image', self.theme_images[f'{color}_squaretoggle_on'],
                                       ('disabled',
                                        self.theme_images[f'{color}_squaretoggle_disabled']),
                                       ('!selected',
    ...
    def _style_solid_toolbutton(self):
        ...
        *ttk.Checkbutton*)
        ...
        disabled_bg = (ThemeColors.update_hsv(self.theme.colors.inputbg, vd=-0.2) if self.theme.type == 'light' else
                       ThemeColors.update_hsv(self.theme.colors.inputbg, vd=-0.3))
        ...
        for color in self.theme.colors:
            self.settings.update({
                f'{color}.Toolbutton': {
                    'configure': {
                        'foreground': self.theme.colors.selectfg,
                        'background': ThemeColors.update_hsv(self.theme.colors.get(color), sd=normal_sd, vd=normal_vd),
                        'bordercolor': ThemeColors.update_hsv(self.theme.colors.get(color), sd=normal_sd, vd=normal_vd),
                        'darkcolor': ThemeColors.update_hsv(self.theme.colors.get(color), sd=normal_sd, vd=normal_vd),
                        'lightcolor': ThemeColors.update_hsv(self.theme.colors.get(color), sd=normal_sd, vd=normal_vd),
                        'relief': 'raised',
                        'focusthickness': 0,
                        'focuscolor': '',
                        'padding': (10, 5)},
            ...
            'Outline.Toolbutton': {
                ...
                'map': {
                    ...
                    'background': [
                        ('pressed !disabled', ThemeColors.update_hsv(
                            self.theme.colors.primary, vd=pressed_vd)),
                        ('selected !disabled', ThemeColors.update_hsv(
                            self.theme.colors.primary, vd=pressed_vd)),
                        ('hover !disabled', self.theme.colors.primary)],
                    'bordercolor': [
                        ('disabled', disabled_fg),
    ...
    def _style_entry(self):
        ...
        if self.theme.type == 'dark':
            self.settings.update(
                {'Entry.field': {'element create': ('from', 'default')}})
        ...
        self.settings.update({
            'Radiobutton.indicator': {
                'element create': ('image', self.theme_images['primary_radio_on'],
                                   ...
                                   ('!selected',
                                    self.theme_images['primary_radio_off']),
            ...
            self.settings.update({
                ...
                f'{color}.TRadiobutton': {
                    ...
                    'map': {
                        ...
                        'indicatorforeground': [
                            ('disabled', disabled_fg),
                            ('active selected !disabled', ThemeColors.update_hsv(self.theme.colors.get(color), vd=-0.2))]}}})
    ...
    def _create_radiobutton_images(self, colorname):
        ...
        draw.ellipse([2, 2, 132, 132], outline=off_border,
                     width=3, fill=off_fill)

        # radio on
        radio_on = Image.new('RGBA', (134, 134))
        draw = ImageDraw.Draw(radio_on)
        draw.ellipse([2, 2, 132, 132], outline=on_border,
                     width=12 if self.theme.type == 'light' else 6, fill=on_fill)
        ...
        draw.ellipse([2, 2, 132, 132], outline=disabled_fg,
                     width=3, fill=off_fill)
            ...
            self.settings.update({
                f'{color}.Checkbutton.indicator': {
                    'element create': ('image', self.theme_images[f'{color}_checkbutton_on'],
                                       ('disabled',
                                        self.theme_images[f'{color}_checkbutton_disabled']),
                                       ('!selected',
                ...
                f'{color}.TCheckbutton': {
                    ...
                    'map': {
                        'foreground': [
                            ('disabled', disabled_fg),
                            ('active !disabled', ThemeColors.update_hsv(self.theme.colors.get(color), vd=-0.2))]}}})
    ...
    def _create_checkbutton_images(self, colorname):
        ...
        draw.rounded_rectangle([2, 2, 132, 132], radius=16,
                               outline=off_border, width=3, fill=off_fill)
        ...
        draw.rounded_rectangle([2, 2, 132, 132], radius=16,
                               fill=on_fill, outline=on_border, width=3)
        ...
        draw.rounded_rectangle([2, 2, 132, 132], radius=16,
                               outline=disabled_fg, width=3, fill=disabled_bg)

        return {
            f'{colorname}_checkbutton_off':
                ImageTk.PhotoImage(checkbutton_off.resize(
                    (14, 14), Image.LANCZOS)),
            f'{colorname}_checkbutton_on':
                ImageTk.PhotoImage(checkbutton_on.resize(
                    (14, 14), Image.LANCZOS)),
            ...
            'TMenubutton': {
                ...
                'map': {
                    ...
                    'background': [
                        ...
                        ('pressed !disabled', ThemeColors.update_hsv(
                            self.theme.colors.primary, vd=pressed_vd)),
                        ('hover !disabled', ThemeColors.update_hsv(self.theme.colors.primary, vd=hover_vd))],
                    'bordercolor': [
                        ('disabled', disabled_bg),
                        ('pressed !disabled', ThemeColors.update_hsv(
                            self.theme.colors.primary, vd=pressed_vd)),
                ...
                f'{color}.TMenubutton': {
                    ...
                    'map': {
                        ...
                        'background': [
                            ...
                            ('pressed !disabled', ThemeColors.update_hsv(
                                self.theme.colors.get(color), vd=pressed_vd)),
                            ('hover !disabled', ThemeColors.update_hsv(self.theme.colors.get(color), vd=hover_vd))],
                        'bordercolor': [
                            ('disabled', disabled_bg),
                            ('pressed !disabled', ThemeColors.update_hsv(
                                self.theme.colors.get(color), vd=pressed_vd)),
